        ...
        <v-card>
          <v-container>
            <v-form @submit.prevent="addEvent" v-if="this.endEndDrag === ''">
              ...
              <v-btn type="submit" color="primary" class="mr-4" @click.stop="addEvent"> Create Event </v-btn>
            </v-form>
...
export default {
  ...
  methods: {
    ...
    async deleteEvent(ev) {
      this.$axios.delete('api/0/user-schedules'+'?2020-03-01');
