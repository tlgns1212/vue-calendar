      ...
      <form class="form-compact" action="">
        <div class="row paddingBottom20">
          <div class="container col-4">
            ...
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">성별</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].mySex}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">나이</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myAge}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
            ...
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">학점</label>
              <div class="col-8">
                <div class="input-group">
            ...
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">토익 스피킹</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myToeicSpeakingScore}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">오픽</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myOpicScore}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">수상 경력</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myContest}}</div>
              </div>
            </div>
            
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">자격증</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myCertification}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">사용 가능한 언어 개수 </label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myForeign}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">인턴 경험 횟수</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myIntern}}</div>
              </div>
            </div>
            
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">해외 경험 횟수</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myTravel}}</div>
              </div>
            </div>
            <div class="form-group row align-items-center">
              <label for="emailAddress" class="col-4 col-form-label-sm text-right">봉사 횟수</label>
              <div class="col-8">
                <div class="input-group">
                  {{this.events[0].myVolunteer}}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col" style="background-color: #a9e6fc">
            ...
            <div class="progress">
              <div
                ...
                {{Math.floor((parseFloat(this.events[0].myToeicScore)/parseFloat(this.eventsCompany.companyToeicScore))*100) > 100 ? 100 : Math.floor((parseFloat(this.events[0].myToeicScore)/parseFloat(this.eventsCompany.companyToeicScore))*100)}}%
              </div>
            ...
            <div class="progress">
              <div
               ...
               :style="SchoolPercentage">
                {{Math.floor((parseFloat(this.events[0].mySchoolScore)/parseFloat(this.eventsCompany.companySchoolScore))*100)}}%
              </div>
            ...
            <div class="progress">
              <div
                ...
                {{Math.floor((parseFloat(this.events[0].myCertification)/parseFloat(this.eventsCompany.companyCertification))*100)}}%
              </div>
            </div>

            외국어(기타)<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyForeign}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.events[0].myForeign)/parseFloat(this.eventsCompany.companyForeign))*100)}}%
              </div>
              </div>

            토익 스피킹<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyToeicSpeakingScore}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.events[0].myToeicSpeakingScore)/parseFloat(this.eventsCompany.companyToeicSpeakingScore))*100)}}%
              </div>
            </div>
            오픽<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyOpicScore}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.OpicState[this.events[0].myOpicScore])/parseFloat(this.OpicState[this.eventsCompany.companyOpicScore]))*100)}}%
              </div>
            </div>
            해외 경험<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyTravel}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.events[0].myTravel)/parseFloat(this.eventsCompany.companyTravel))*100)}}%
              </div>
            </div>
            인턴 경험<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyIntern}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.events[0].myIntern)/parseFloat(this.eventsCompany.companyIntern))*100)}}%
              </div>
            </div>
            수상내역<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyContest}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.events[0].myContest)/parseFloat(this.eventsCompany.companyContest))*100)}}%
              </div>
            </div>
            봉사 횟수<span class="pull-right strong" style="font-weight: bold">{{this.eventsCompany.companyVolunteer}}</span>
            <div class="progress" style="text-align: right">
              <div
                ...
                >
                {{Math.floor((parseFloat(this.events[0].myVolunteer)/parseFloat(this.eventsCompany.companyVolunteer))*100)}}%
              </div>
            </div>
            </div>
...
export default {
  ...
  computed: {
    ...mapState(['userInfo']),
    ToeicScore(){
      return (Math.floor((parseFloat(this.events[0].myToeicScore)/parseFloat(this.eventsCompany.companyToeicScore))*100).toString())
    },
    ToeicPercentage(){
    ...
    SchoolScore(){
      return (Math.floor((parseFloat(this.events[0].mySchoolScore)/parseFloat(this.eventsCompany.companySchoolScore))*100).toString())
    },
    SchoolPercentage(){
    ...
    CertificationScore(){
      return (Math.floor((parseFloat(this.events[0].myCertification)/parseFloat(this.eventsCompany.companyCertification))*100).toString())
    },
    ...
    ForeignScore(){
      return (Math.floor((parseFloat(this.events[0].myForeign)/parseFloat(this.eventsCompany.companyForeign))*100).toString())
    },
    ForeignPercentage(){
    ...
    ToeicSpeakingScoreScore(){
      return (Math.floor((parseFloat(this.events[0].myToeicSpeakingScore)/parseFloat(this.eventsCompany.companyToeicSpeakingScore))*100).toString())
    },
    ...
    OpicScoreScore(){
      return (Math.floor((parseFloat(this.OpicState[this.events[0].myOpicScore])/parseFloat(this.OpicState[this.eventsCompany.companyOpicScore]))*100).toString())
    },
    OpicScorePercentage(){
    ...
    TravelScore(){
      return (Math.floor((parseFloat(this.events[0].myTravel)/parseFloat(this.eventsCompany.companyTravel))*100).toString())
    },
    TravelPercentage(){
    ...
    InternScore(){
      return (Math.floor((parseFloat(this.events[0].myIntern)/parseFloat(this.eventsCompany.companyIntern))*100).toString())
    },
    InternPercentage(){
    ...
    ContestScore(){
      return (Math.floor((parseFloat(this.events[0].myContest)/parseFloat(this.eventsCompany.companyContest))*100).toString())
    },
    ContestPercentage(){
    ...
    VolunteerScore(){
      return (Math.floor((parseFloat(this.events[0].myVolunteer)/parseFloat(this.eventsCompany.companyVolunteer))*100).toString())
    },
    VolunteerPercentage(){
