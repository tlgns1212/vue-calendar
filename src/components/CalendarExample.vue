<template>
  <v-row class="fill-height" @click="outsideClicked">
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat>
          ...
          <v-btn fab text small color="red" @click="keyword" class="mr-4">
            Toeic
          </v-btn>
      ...
      <v-dialog v-model="dialog" max-width="500">
        <v-card>
          <v-container>
            ...
            <v-form
              @submit.prevent="addEventKeyword"
              v-else-if="keywordpushed === true"
            >
              <v-text-field
                v-model="details"
                type="text"
...
export default {
  ...
  methods: {
    ...
    async addEventKeyword() {
      if (this.keywordpushed) {
        await db.collection("calEvent").add({
          name: this.name,
          details: this.details,
    ...
    keyword() {
      this.keywordpushed = !this.keywordpushed;
    },
    outsideClicked() {
      console.log("dialog = " + this.dialog);
      if (this.keywordpushed && this.dialog) {
        this.keywordpushed = false;
        console.log(this.keywordpushed);
      }
    },
  },
};
