...
<div class="searchWrap">
    ...
    <v-btn :href=item.url>자세히 보기</v-btn>
					...
					<td v-if="item['expiration-timestamp'] > 1700000000">
                        상시 채용
                        </td>
                        <td v-else>
                        {{UnixToDate(item["opening-timestamp"])}} ~ {{UnixToDate(item["expiration-timestamp"]) }}
                        </td>
				</tr>
				<tr v-if="1 == 0">
...
export default {
  data: () => ({
    ...
    loc_cd: "",
    job_mid_cd: "",
    jobMidCD: ["(16)기획·전략","(14)마케팅·홍보·조사","(3)회계·세무·재무","(5)인사·노무·HRD","(4)총무·법무·사무","(2)IT개발·데이터","(15)디자인","(8)영업·판매·무역","(21)고객상담·TM","(18)구매·자재·물류","(12)상품기획·MD","(7)운전·운송·배송","(10)서비스","(11)생산","(22)건설·건축","(6)의료","(9)연구·R&D","(19)교육","(13)미디어·문화·스포츠","(17)금융·보험","(20)공공·복지"],
    locStates: ["서울(101000)","경기(102000)","광주(103000)","대구(104000)","대전(105000)","부산(106000)","울산(107000)","인천(108000)","강원(109000)","경남(110000)","경북(111000)","전남(112000)","전북(113000)","충북(114000)","충남(115000)","제주(116000)","전국(117000)","세종(118000)"],
    apiSearch: "api/announcements?",
    dialog: [false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false,false],
...
consoleGo(){
    ...
    fnSearch(){
        ...
        this.$axios
        .get(
          "api/announcements?keywords="+this.keyword+"&job_type=1&edu_lv=0&loc_cd="+this.loc_cd.substr(3,6)+"&job_mid_cd="+this.job_mid_cd+""
        )
        .then((res) => {
          this.events = res;
        });
